            ...
            <section>
              ...
              <div className="relative rounded-2xl">
                <span className={`${imgLoading ? "inline-block" : "hidden"} 
                    rounded-xl absolute w-full h-full transition-all duration-500
                     ease-in-out  lg:rounded-2xl bg-gradient-to-r from-[var(--color-main)]
                      to-[var(--color-orange)] animate__animated animate__flash
                       animate__slower	2s animate__infinite	infinite`}>
                </span>
