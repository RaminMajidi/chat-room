...
const Header = ({activeNavItem})=>{
    ...
    return(
       <nav className="fixed z-50 bg-[var(--color-pray)]  lg:bg-transparent  w-full lg:w-[5rem] px-2 py-4 bottom-0 right-0 lg:top-[22vh] h-[5rem] lg:h-[max-content] lg:right-5 text-[var(--color-text)] ">
